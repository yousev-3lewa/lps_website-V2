...
<body>
    <!--NavigationBar-->
    <nav class="bg-darkblue" style="padding-bottom: 15px;">
        <div class="navitems">
    ...
    <div class="role">
        ...
        <div>
            <p>The need for a fresh hamburger and fries is real. Same goes for a job that lets you be you. Here at Los
                Pollos Hermanos’, we’ll work with your needs. And we’ll celebrate who you are. Bring your real self and
                let’s do this thing. And have some
                fun, too. <b>WE GET YOU. WE GOT YOU!</b></p>
        </div>
    </div>
    ...
    <div class="video-grid-container">
        ...
        <div class="lph-video">
            <video controls id="lph-video" poster="./images/background/video-thumbnail.png">
                <source src="./videos/los-pollos-hermanos.mp4" type="video/mp4">
            </video>
        </div>
        <div>
    ...
    <section class="wwd-container">
        <div class="wwd-franchise">
            <div class="wwd-content">
                ...
                <p>Los Pollos Hermanos is a company that's constantly growing. From the first restaurant, we've
                    continued to expand Fring Gustavos' vision to help other people become successful business owners by
                    owning a Los Pollos Hermanos franchise. We
        ...
        <div class="wwd-invesment">
            <div class="wwd-content">
                ...
                <p>Check out the latest news, financial information and facts about Los Pollos Hermanos common stock. If
                    you're an investor, financial analyst or find reading a 10-K thrilling, everything you need to know
                    is right here.</p><br>
    ...
    <section class="chicken-sandwich">
        ...
        <div class="chicken-sandwich-content">
            <h1>Our chicken delivers—<br>and gets delivered.</h1><br><br><br>
            <p>If it’s spicy you need, we got the OG Spicy Chicken Sandwich. We also got those Made to Crave chicken
                sandwiches your taste buds are dreaming about. Oh, and you know we’re all about that nugg life.</p>
        </div>
    </section>
    ...
    <section class="menu" id="menu">
        ...
        <article class="menu-text">
            <div class="menu-text-center"><br><br><br><br><br>
                <p>“It's the best ingredients. The spiciest spices. All prepared with loving care! And always delivered
                    with a friendly smile. That's the Los Pollos Hermanos promise.”</p>
                <p style="font-size: 15px; text-align: right;">Gustavo Fring -- Owner and Proprietor</p>


                <br><a href="./menu.html">Explore</a><br>
    ...
    <section class="spicy-chicken">
        ...
        <div class="spicy-chicken-content">
            <form action="./menu.html">
                ...
                <br>
                <p>You can get all hot with a Spicy Chicken Sandwich and a 10 PC Spicy Nugg, or keep it cool with a
                    Homestyle Chicken Sandwich and 10 PC Crispy Nugg. You can even double up on the nuggs if you want.
                </p>
                <br>
    ...
    <section class="copyright-sprite">
        ...
        <p> If you don’t like something you got for breakfast, you can either show us your original receipt—like, your
            legit receipt. No tricky stuff. Or you can contact Los Pollos Hermanos Customer Care, give them your receipt
            and contact info, and they’ll
            take care of you. Either way, you gotta do it by 10:30 AM the next day. Bottled drinks and full combos don’t
            count. No credit or refunds, and only one exchange per receipt. We ARE still a business, after all.
            Promotion available for a limited
